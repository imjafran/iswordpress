...
<template>
    <div class="relative flex flex-col gap-5 my-3 text-lg text-slate-700">
        ...
        <div class="flex items-center justify-between mx-5 my-4">
            <!-- count  -->
            <span class="flex items-center gap-1 text-xl text-gray-600"> 
                ...
                </svg> {{ pluginsLength }} plugin{{pluginsLength === 1 ? '' : 's'}} found</span>
        ...
        <div class="flex flex-col gap-3">
            <Plugin v-for="slug in Object.keys(plugins)" :slug="slug"/>
        </div>
    </div>
</template>