<template>
    ...
    <!-- header  -->
    <header class="tracking-wide border-b border-slate-200">
        <h1 class="flex items-center justify-center gap-3 px-3 py-4 text-gray-700">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 text-teal-600 rounded-full fill-current" viewBox="0 0 16 16">
            ...
            </svg> <span class="text-2xl font-thin">WordPress Inside!</span>
        </h1>
    </header>
</template>